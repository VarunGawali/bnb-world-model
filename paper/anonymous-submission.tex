...
model faithful across multiple steps and we adopt
latent overshooting as a training-time stabilizer to keep the learned forward
model faithful across multiple steps. We bring this inside Branch-and-Cut, combining the
...
explicit LP look-ahead, we \emph{imagine} the downstream consequences a decision
induces and recover part of strong branching's look-ahead signal at the cost
of a short latent rollout per candidate. A single such model drives
