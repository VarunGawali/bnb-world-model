...
therefore use the attention rule as the deployed selection mechanism; the
learned pointer head is an ablation evaluated via the gap columns of
Tables~\ref{tab:main} and~\ref{tab:hard}.
