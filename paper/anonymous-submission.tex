...
method: $({\rm obj}-{\rm best})/{\rm best}\times100$.}
\label{tab:main}
\begin{center}
...
\midrule
Most-fractional        &  0/10 & 4{,}873 & ---  & 301.4 & 2.7\% \\
Classical SB-1         &  0/10 & 4{,}605 & ---  & 301.3 & 2.7\% \\
Classical SB-4         &  0/10 & 3{,}024 & ---  & 301.0 & 3.2\% \\
Classical SB-8         &  0/10 & 2{,}710 & ---  & 300.8 & 3.6\% \\
\midrule
Policy (imitation)     & 10/10 & --- & 5{,}733     & 237.6 & 5.9\% \\
\quad + MF-blend       & 10/10 & --- & 4{,}165     & \textbf{218.1} & 3.1\% \\
\quad + Cuts (attn)    & 10/10 & --- & 5{,}396     & 240.4 & 5.2\% \\
\quad + Rollout-d1     & 10/10 & --- & \textbf{3{,}197} & 271.4 & 6.8\% \\
\quad + Rollout-d1+Size& 10/10 & --- & 4{,}320     & 258.8 & 5.9\% \\
\textbf{Neural-Best (d1)} & 10/10 & --- & 3{,}235  & 242.4 & \textbf{3.4\%} \\
...
medium tier, Policy reaches $+5.9\%$ vs best-known while MF is $+2.7\%$; at
...
reaches $+3.4\%$ --- the best among all neural configurations and competitive
with SB-4 ($+3.2\%$) --- and at hard tier $+2.1\%$ (d1) and $+1.9\%$ (d3),
