...
hard tier, Policy is $+2.9\%$ while MF is $+1.3\%$. The full model
...
pp of MF --- and at hard tier $+2.1\%$ (d1) and $+1.9\%$ (d3),
within $0.6$ pp of the best classical method, which does not terminate. This is
